...
def extract_education_from_resume(text):
    ...
    education_keywords = [
        ...
        'Ethics', 'Early Childhood Education', 'Elementary Education', 'Secondary Education', 'Special Education',
        'Higher Education',
...
def pred():
    if 'resume' in request.files:
        ...
        if filename.endswith('.pdf'):
            ...
            return render_template('resume.html',message="File type not supported.")
